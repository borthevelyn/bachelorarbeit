...
void path0(int _bf73, int _bf57, int _bf59, int* c_1_1) { 
    int _bf64 = _bf59 * _bf57;
    int _bf65 = *c_1_1 + _bf64;
    *c_1_1 = _bf65 + _bf73;
}
void path1(int _bf23, int* _bf54, int* b_1_0, int* _bf38, int* _bf15, int* b_0_0, int* _bf0) { 
    *_bf0 = *b_1_0;
    int _bf9 = *b_1_0;
    int _bf96 = _bf9;
    *b_0_0 = _bf9;
...
void path2(int _bf10, int _bf11, int* _bf35, int* a_0_1, int* _bf21, int* a_0_0, int* _bf14) { 
    *_bf14 = _bf11;
    int _bf18 = _bf11;
    int _bf93 = _bf18;
    *a_0_0 = _bf18;
...
void path3(int* b_1_1, int* _bf72, int* _bf57, int* _bf34, int* b_0_1, int* _bf19) { 
    *_bf19 = *b_1_1;
    int _bf28 = *b_1_1;
    int _bf91 = _bf28;
    *b_0_1 = _bf28;
...
void path4(int c_0_0, int _bf0, int a_0_1, int* _bf24, int* _bf11) { 
    int _bf2 = a_0_1;
    *_bf11 = a_0_1;
    int _bf7 = _bf2 * _bf0;
    int _bf8 = c_0_0 + _bf7;
...
void path5(int a_1_1, int* _bf68, int* _bf59, int* a_1_0, int* _bf52, int* _bf40) { 
    *_bf40 = a_1_1;
    int _bf49 = a_1_1;
    *_bf52 = _bf49;
    int _bf56 = _bf49;
...
void path6(int _bf72, int _bf68, int* _bf73, int* a_1_1) { 
    int _bf71 = _bf68;
    *a_1_1 = _bf68;
    *_bf73 = _bf71 * _bf72;
}
void path7(int _bf24, int _bf15, int _bf14, int* c_0_0) { 
    int _bf1 = _bf14;
    int _bf16 = _bf1 * _bf15;
    *c_0_0 = _bf24 + _bf16;
}
void path8(int _bf35, int _bf21, int _bf19, int* c_0_1) { 
    int _bf3 = _bf19;
    int _bf4 = _bf3;
    int _bf5 = _bf4;
...
void path9(int _bf34, int* _bf10) { 
    int _bf6 = _bf34;
    *_bf10 = _bf6;
}
void path10(int _bf54, int _bf38, int _bf40, int* c_1_0) { 
    int _bf12 = _bf40;
    int _bf13 = _bf12;
    int _bf17 = _bf13;
...
void path11(int _bf52, int* _bf23) { 
    int _bf20 = _bf52;
    int _bf22 = _bf20;
    *_bf23 = _bf22;
}
...
int main(int argc, char** argv)
{
    ...
    for (int i = 0; i < DATA_SIZE; i++) {
       ...
       {
           #pragma omp section
               path3(&b_1_1, &_bf72, &_bf57, &_bf34, &b_0_1, &_bf19);
           #pragma omp section
               path5(a_1_1, &_bf68, &_bf59, &a_1_0, &_bf52, &_bf40);
       }
       #pragma omp parallel sections
       {
           #pragma omp section
               path6(_bf72, _bf68, &_bf73, &a_1_1);
           #pragma omp section
               path9(_bf34, &_bf10);
           #pragma omp section
               path11(_bf52, &_bf23);
       ...
       {
           #pragma omp section
               path0(_bf73, _bf57, _bf59, &c_1_1);
           #pragma omp section
               path1(_bf23, &_bf54, &b_1_0, &_bf38, &_bf15, &b_0_0, &_bf0);
       }
       #pragma omp parallel sections
       {
           #pragma omp section
               path4(c_0_0, _bf0, a_0_1, &_bf24, &_bf11);
           #pragma omp section
               path10(_bf54, _bf38, _bf40, &c_1_0);
       }
       path2(_bf10, _bf11, &_bf35, &a_0_1, &_bf21, &a_0_0, &_bf14);
       #pragma omp parallel sections
       {
           #pragma omp section
               path7(_bf24, _bf15, _bf14, &c_0_0);
           #pragma omp section
               path8(_bf35, _bf21, _bf19, &c_0_1);
       }
